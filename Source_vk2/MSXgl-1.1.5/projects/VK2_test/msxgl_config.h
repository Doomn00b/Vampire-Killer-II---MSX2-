...
#define BIOS_USE_MAINROM			FALSE	// Allow use of Main-ROM routines / Do not allow use of Main-routines
#define BIOS_USE_VDP				FALSE	// Give access to Main-ROM routines related to VDP / Do not
#define BIOS_USE_PSG				FALSE	// Give access to Main-ROM routines related to PSG / Do not
...
#define VDP_USE_RESTORE_S0			TRUE	// Do restore of status register pointer to S#0 (needed only for default BIOS ISR)
...
#define INPUT_KB_UPDATE_MAX			10		// Last row to update (10 for numerical-pad, 8 otherwise)
...
#define GAMEPAWN_BORDER_MAX_Y		204		// Low border Y coordinate
...
#define GAMEPAWN_TILEMAP_HEIGHT		32		// Height of the tiles map
...
#define BITBUSTER_WRITE_MODE		BITBUSTER_WRITE_QUICK
...
#define ZX0_MODE					ZX0_MODE_TURBO
